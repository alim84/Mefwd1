  ...
  return (
    <>
      <div className="bg-black/40 w-screen h-screen pt-[120px] ">
        <div className="w-[600px] h-[600px] bg-black/10 shadow-2xl shadow-white rounded-3xl mx-auto  ">
          ...
          <div className="relative">
            <button className=" absolute bg-blue-500 text-[10px] py-3 px-6 rounded-lg translate-x-[570px] translate-y-[-120px] shadow-sm shadow-blue-900">
              Request An Account
            </button>
            <button className="absolute bg-white text-[10px] py-3 px-6 rounded-lg translate-x-[590px] translate-y-[-60px] shadow-sm shadow-gray-300">
              Need Help?
            </button>
          </div>
        </div>
