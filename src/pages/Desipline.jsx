...
const Desipline = () => {
  ...
  return (
    <>
        ...
        <div className=" container mx-auto bg-cyan-900 py-5 px-5 rounded-b-lg shadow-2xl shadow-gray-400">
          <div className="mb-12 text-center font-bold text-2xl text-yellow-200">
            ...
            <div className="grid-cols-2 justify-between mx-auto  mt-10 p-5 outline-gray-400 outline outline-3 border-2 border-r-rose-500 border-b-rose-500/75  border-l-rose-500/50  border-t-rose-500/25 ">
