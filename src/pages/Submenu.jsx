      ...
      <div className=" container flex mx-auto gap-5 justify-end items-center bg-cyan-900 text-yellow-200 shadow-md shadow-gray-100 relative py-[22px] ">
        ...
        <div className="relative">
          <button
            ...
            className="flex relative mr-10  py-3 px-3 rounded-full bg-purple-900  "
          >
            <a className="hover:text-md text-[20px] text-yellow-100  font-semibold hover:text-white">
              <DiAppstore />
            </a>
          </button>
          <div>
            {toggle && (
              <div className="absolute translate-x-[-570px] translate-y-[-17px] cursor-pointer  grid grid-cols-4 justify-between items-center w-[600px] h-[200px] rounded-b-md bg-cyan-900  z-20 mt-10 text-center text-white font-semibold text-[13px] transition delay-150 duration-300 ease-in-out shadow-md shadow-slate-200  ">
